  ...
  if (!isStarted) {
    return (
      <div className="text-center p-8">
        <Card className="max-w-md mx-auto plant-shadow border-violet-100">
          <CardHeader>
        ...
        <Card className="max-w-md mx-auto plant-shadow border-violet-100">
          <CardContent className="py-8">
            <div className="flex flex-col items-center">
              <div className="animate-spin rounded-full h-10 w-10 border-4 border-violet-600 border-t-transparent mb-4"></div>
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-2">
        ...
        <span className="text-violet-600 font-medium">Score: {quizScore}</span>
      </div>
      
      <Progress value={progressPercentage} className="h-2 mb-4 bg-violet-100" />
            
      <Card className="mb-6 plant-shadow border-violet-100">
        <CardHeader>
          ...
          {currentQuestion.options.map((option, index) => (
            <Button
              ...
              className={`w-full justify-start font-normal ${
                selectedAnswer === option ? "bg-violet-600 hover:bg-violet-700" : "hover:border-violet-600 hover:text-violet-600"
              }`}
