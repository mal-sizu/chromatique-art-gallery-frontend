...
const PostCard = ({ post, onDelete, onEdit }: PostCardProps) => {
  ...
  return (
    <Card className="mb-6 overflow-hidden plant-card border-violet-100">
        ...
        <div className="flex items-center space-x-2">
          ...
          {!isOwnPost && isAuthenticated && (
            <Button 
              ...
              className={isFollowing ? "border-violet-500 text-violet-500" : "bg-violet-500 hover:bg-violet-600"}
            >
          ...
          <div className="p-4 space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                className="w-full resize-none border-violet-200"
                rows={4}
              />
            </div>
      ...
      <CardFooter className="flex flex-col p-0">
        <div className="flex items-center justify-between p-4 border-t border-violet-100">
            ...
            {isAuthenticated && (
              <form onSubmit={handleCommentSubmit} className="flex space-x-2">
                <Textarea
                  ...
                  className="resize-none border-violet-200"
                  rows={1}
                />
                <Button
                  type="submit"
