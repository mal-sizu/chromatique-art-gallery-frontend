    ...
    <>
      <div className="bg-white shadow rounded-lg p-6 mb-6 plant-shadow">
        <div className="flex flex-col md:flex-row items-center">
          <Avatar className="h-20 w-20 md:h-24 md:w-24 border-4 border-violet-100">
            ...
            {isOwnProfile ? (
              <Dialog open={editOpen} onOpenChange={setEditOpen}>
                <DialogTrigger asChild>
                  <Button variant="outline" className="border-violet-200 hover:bg-violet-50 hover:text-violet-700">
                    Edit Profile
                  </Button>
                </DialogTrigger>
                <DialogContent>
